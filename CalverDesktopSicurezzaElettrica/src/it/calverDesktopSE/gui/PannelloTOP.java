...
import it.calverDesktopSE.bo.GestioneDB;
import it.calverDesktopSE.bo.GestioneRegistro;
import it.calverDesktopSE.bo.SessionBO;
import it.calverDesktopSE.dao.SQLiteDAO;
import it.calverDesktopSE.gui.PannelloImpostazioni.ValidateThread;
			...
			public void actionPerformed(ActionEvent e) {
				 ...
				 if(cmd.equals("APRI"))
				 {
					 ...
					 String last_path="";
	    				...
	    				javax.swing.filechooser.FileFilter docFilter = new it.calverDesktopSE.utl.FileTypeFilter(".db", "Calver database");
